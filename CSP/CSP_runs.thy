           (*-------------------------------------------*
            ...
            |                 2022 / 2023               |
            |                                           |
            |      From on CSPIO encoding by Isobe      |
            |                                           |
...
subsection \<open> definitions and lemmas for RUN A based on CSPIO \<close>

text \<open> RUN can be defined by basic CSP processes, but it is defined in more general style here. \<close>
